...
def load_corpus(dataset_str):
    ...
    objects = []
    for i in range(len(names)):
        with open("drive/My Drive/Colab Notebooks/text_gcn-master/text_gcn-master/data/ind.{}.{}".format(dataset_str, names[i]), 'rb') as f:
            if sys.version_info > (3, 0):
                objects.append(pkl.load(f, encoding='latin1'))
            else:
                objects.append(pkl.load(f))
    ...
    train_idx_orig = parse_index_file(
        "drive/My Drive/Colab Notebooks/text_gcn-master/text_gcn-master/data/{}.train.index".format(dataset_str))
