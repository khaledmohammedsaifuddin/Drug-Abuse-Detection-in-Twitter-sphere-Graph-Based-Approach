...
f = open('drive/My Drive/Colab Notebooks/text_gcn-master/text_gcn-master/data/corpus/' + dataset + '_vocab.txt', 'r')
words = f.readlines()
f.close()
...
word_embeddings_str = '\n'.join(word_vectors)
f = open('drive/My Drive/Colab Notebooks/text_gcn-master/text_gcn-master/data/' + dataset + '_word_vectors.txt', 'w')
...
doc_embeddings_str = '\n'.join(doc_vectors)
f = open('drive/My Drive/Colab Notebooks/text_gcn-master/text_gcn-master/data/' + dataset + '_doc_vectors.txt', 'w')
